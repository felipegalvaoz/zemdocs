...
// Client implementa documents.Client para Imperatriz-MA
type Client struct {
	baseURL    string
...
// ConsultarDocuments implementa documents.Client
func (c *Client) ConsultarDocuments(ctx context.Context, req documents.ConsultarRequest) (*documents.Response, error) {
	...
	var nfseResp documents.Response
...
func (c *Client) ConsultarXMLDocuments(ctx context.Context, req documents.ConsultarXMLRequest) ([]documents.Response, error) {
	...
	var apiResp documents.ImperatrizAPIResponse
...
func (c *Client) convertToStandardFormat(dados []documents.ImperatrizNFSeRecord) ([]documents.Response, error) {
	var responses []documents.Response
	...
	for _, record := range dados {
		...
		response := documents.Response{
			DocumentType:      documents.DocumentTypeNFSe,
			NumeroDocumento:   strconv.Itoa(record.NrNfse),
			NumeroNfse:        strconv.Itoa(record.NrNfse), // Para compatibilidade
